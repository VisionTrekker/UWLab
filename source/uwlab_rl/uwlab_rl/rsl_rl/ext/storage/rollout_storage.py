...
class RolloutStorage:
    ...
    def __init__(
        ...
        expert_action_mean_shape=None,
        expert_action_sigma_shape=None,
        device="cpu",
    ):
        # store inputs
        self.device = device
        ...
        # For bc
        self.expert_action_mean_shape = expert_action_mean_shape
        self.expert_action_sigma_shape = expert_action_sigma_shape
        ...
        # For BC
        if expert_action_mean_shape is not None:
            self.expert_action_mean = torch.zeros(
                num_transitions_per_env, num_envs, *expert_action_mean_shape, device=self.device
            )
        if expert_action_sigma_shape is not None:
            self.expert_action_sigma = torch.zeros(
                num_transitions_per_env, num_envs, *expert_action_sigma_shape, device=self.device
            )
    ...
    def add_transitions(self, transition: Transition):
        ...
        # For BC
        if transition.expert_action_mean is not None:
            self.expert_action_mean[self.step].copy_(transition.expert_action_mean)
        if transition.expert_action_sigma is not None:
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        if self.expert_action_mean_shape is not None:
            expert_action_mu = self.expert_action_mean.flatten(0, 1)
        if self.expert_action_sigma_shape is not None:
            expert_action_sigma = self.expert_action_sigma.flatten(0, 1)
